      ...
      <div className="container py-8 mx-auto">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="h-10 w-10 bg-primary rounded-md flex items-center justify-center">
                <span className="font-bold text-primary-foreground">DR</span>
              </div>
              <h3 className="text-lg font-bold">DoorRush</h3>
            </div>
            <p className="text-muted-foreground text-sm">
              Fast, reliable delivery for all your needs in Eldoret and beyond.
            </p>
          </div>
        ...
        <div className="border-t border-border mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} DoorRush. All rights reserved.
          </p>
